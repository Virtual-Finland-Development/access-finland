...
import type { PersonBasicInformation } from '@shared/types';
import api from '@shared/lib/api';
import { useCountries } from '@shared/lib/hooks/codesets';
import { BASIC_INFO_QUERY_KEYS } from '@shared/lib/hooks/profile';
