...
/**
 * Dynamic import, resolves if exported static app (af-features) or app running with server (af-mvp).
 * 'next/image' can't be used with exported apps for image optimization, use 'next-image-export-optimizer' module instead.
 * 'next-image-export-optimizer' has its custom loader configs in apps/af-features/next.config.js.
 */
